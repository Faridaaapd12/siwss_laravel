...
Route::post('/cart/add',[CartController::class, 'indexCart1']);
...
Route::name('admin.')->prefix('admin')->group(function () {
    ...
    Route::get('/add-listing', [PackageController::class, 'createForm'])->middleware('dashboard');
    ...
    Route::get('/listing/{id}', [PackageController::class, 'viewlisting'])->middleware('dashboard');
});
