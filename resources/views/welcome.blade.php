	...
	<div id="page">
		...
		<main>
					...
					<div class="container">
						...
						<form action="{{url('/search')}}" method="POST">
							...
							<div class="row no-gutters custom-search-input-2">
								...
								<div class="col-lg-4">
									<div class="form-group">
										<input class="form-control" type="text" name="maxpeople" placeholder="Kapasitas Orang">
										<i class="icon_plus"></i>
									</div>
								</div>
								<div class="col-lg-4">
			...
			<div class="container container-custom margin_80_0">
				...
				<div id="reccomended" class=" row owl-carousel owl-theme owl-loaded owl-drag">
						...
						<div class="box_grid">
							<figure>
								...
								<a href="{{ route('package-detail') }}">
									<img src="img/Foto Menyusuri Sungai.jpg" class="img-fluid" alt="" width="800" height="533">
							...
							<div class="wrapper">
								...
								<span class="price">Mulai <strong>Rp {{ $package->price }}</strong> /per paket</span>
							</div>
							<ul>
				...
				<p class="btn_home_align"><a href="{{ url('/packages/grid') }}" class="btn_1 rounded">Lihat Semua Paket</a></p>
				...
				<ul class="magnific-gallery">
                    ...
                    <li>
						<figure>
							...
							<figcaption>
								<div class="caption-content">
									<a href="img/cafe kalitekung.jpg" title="Photo title" data-effect="mfp-zoom-in">
										<i class="pe-7s-albums"></i>
										<p>Keterangan</p>
									</a>
								</div>
