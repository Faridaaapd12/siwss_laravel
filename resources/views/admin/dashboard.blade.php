  ...
  <div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="box_general padding_bottom">
          ...
          <div class="row">
            <div class="col">
              <h5 style="margin-left:12px;">How Many Time Package is Ordered at {{session('year')}}</h5>
              <table class="table" id="order-count">
                ...
                {{-- <tbody>
                  @foreach ($ordersCount as $packageName => $count)
                    <tr>
                      <td>{{ $packageName }}</td>
                      <td>{{ $count }}</td>
                    </tr>
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 
                      ...
                      'Nov', 'Des'],
            datasets: [{
                label: "Total Successful Package Purchase at {{session('year')}}",
                data: priceData,
