                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">{{ $package->location }}</div>
                            </div>
                            <hr />
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">{{ $package->maxpeople }}</div>
                            </div>
                            <hr />
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a href="{{ url("/admin/update-listing/{$package->id}") }}"
                                        class="btn btn-primary text-white" style="position: relative; bottom:18px">
                                        Update
                                    </a>
                                </div>
                            </div>
